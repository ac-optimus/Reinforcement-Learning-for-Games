...
def run_simulation():
    ...
    gym.wrappers.Monitor(env,os.path.join(OUTPUT_DIR, MONITOR_DIR), force=True, video_callable=hundred_video_callable)
    env.reset()
    ...
    for i_episode in range(NUM_EPISODES):
        ...
        while True:
            ...
            if done:
                ...
                print("Timesteps : %s Reward Obtained : %s"%(t+1,reward_accum))
                break
